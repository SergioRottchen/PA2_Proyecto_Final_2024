...
Controladora control;
    ...
    public AltaProveedor(Controladora control) {
         initComponents();
...
try{
        control.crearProveedor(nombre,servicio,precio,telefono,correo);
        mostrarMensaje("Proveedor creado con exito","Info","Creación exitosa");}
catch(Exception e){
mostrarMensaje("Proveedor creado con exito","Info","Creación exitosa");
}
